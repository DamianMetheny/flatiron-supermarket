...
function purchaseItem() {
    const itemToPurchase = prompt("Please select an item to purchase:/n/n-Enter 'apple' to purchase an apples/n-Enter 'banana' to purchase a bananas/n-Enter 'pineapple'  to purchase a pineapples");
...
const option = prompt("What would you like to do?/n/n- Enter '1' to purchase an item from the supermarket/n- Enter '2' to add an item to the supermarket");
